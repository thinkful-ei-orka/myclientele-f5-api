...
usersRouter
    .post('/', jsonBodyParser, async (req, res, next) => {
        const { name, userName, password, company_name, company_location, admin, email} = req.body
        for (const field of ['name', 'userName','password','company name', 'company location','admin', 'email'])
            if (!req.body[field])
