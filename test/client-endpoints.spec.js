  ...
  describe("GET /api/clients", () => {
    context("given clients exist", () => {
      ...
      it("should respond with 200 and the clients", () => {
        const expectedClient = testClients.filter(
          (client) => client.sales_rep_id === testUsers[0].id
        );
    ...
    it("creates client, res of 201 and new client", () => {
      ...
      return supertest(app)
        ...
        .expect((res) => {
          ...
          expect(res.body.hours_of_operation).to.eql(
            newClient.hours_of_operation
          );
        ...
        .expect((res) =>
          db
            ...
            .then((row) => {
              ...
              expect(row.hours_of_operation).to.eql(
                newClient.hours_of_operation
              );
  ...
  describe("DELETE /api/clients/:client_id", () => {
    ...
    context("Given there are clients in DB", () => {
      ...
      it("responds with 204 and removes client", () => {
        const idToRemove = 2;
        const expectedClients = testClients.filter(
